from behviour_analysis_funcs import group_td_df_across_sessions
...
#     # rare_freq_diff_plot[0].savefig(rare_freq_figdir / 'rare_freq_diff_plot.pdf')
    ...
    for cond in ['rare', 'frequent']:
        for n_sess in [5]:
            ...
            for sess_i, sess_i_sessions in rare_freq_sess_by_sess_num.items():
                ...
                plot_pupil_ts_by_cond(A_by_cond, [cond,],
                                      ...
                                      cond_line_kwargs={'rare':{'c':colors[sess_i]},'frequent':{'c':colors[sess_i]}},
            ...
            rare_freq_sess_adaptaion_plot[0].savefig(rare_by_block_figdir / f'{cond}_resp_sess_adaptaion_plot_upto_{n_sess}.pdf')
    ...
    tukey_across_sess = tukey_hsd(*[e for e in rare_freq_diff_sess_adaptation_df.values])
    print(tukey_across_sess)
