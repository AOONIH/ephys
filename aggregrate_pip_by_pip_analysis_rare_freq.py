...
def main():
    ...
    pip_resps.aggregate_sess_decoding('all_v_all_rare_freq_decoding',
                                      df_save_path=decoding_figdir/'all_v_all_rare_freq_decoding_df.h5',
                                      reload_save=True)
    pip_resps.plot_confusion_matrix(decoding_figdir,plot_config['all_v_all_cm_kwargs'],)
    pip_resps.aggregate_sess_decoding('all_v_all_train_rare_decoding',
                                      df_save_path=decoding_figdir/'all_v_all_train_rare_decoding_df.h5',
                                      conds=(['rare']*4)+(['frequent']*4),
                                      pips=plot_config['all_v_all_train_rare_decoding']['pips2decode'][0])
    pip_resps.plot_confusion_matrix(decoding_figdir,plot_config['all_v_all_cm_kwargs'],)
